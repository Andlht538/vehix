...
class Vehicule extends Model
{
    ...
    //  RELATION ce demandes de modification du véhicule validées par un admin  
    public function editRequests()
    {
        return $this->hasMany(VehiculeEditRequest::class)->orderBy('created_at', 'desc');
    }

    public function pendingEditRequests()
    {
        return $this->hasMany(VehiculeEditRequest::class)->where('status', 'pending');
    }
