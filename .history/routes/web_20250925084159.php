...
Route::middleware([
    ...
    Route::middleware(['vehicle.validation'])->group(function () {
        ...
        Route::post('vehicles/{vehicle}/validate', [VehiculeController::class, 'validate'])
            ->name('vehicles.validate')
            ->middleware('role:validator,admin');

        // Assurances
        Route::resource('insurances', AssusuranceController::class);
        ...
        // Ravitaillements
        Route::resource('fuelings', RavitaillementController::class);
        
        // Trajets
        Route::resource('trips', TrajetController::class);
        
        // Reçus
        Route::resource('receipts', ReuController::class);
        
        // Propriétaires
        Route::resource('owners', ProprietaireController::class);
    });
