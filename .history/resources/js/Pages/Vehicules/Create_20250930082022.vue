          ...
          <form @submit.prevent="submit" class="p-6 space-y-6">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
             ...
             <!-- Champ pour Type véhicule -->
              <div>
                <label for="vehile_type" class="block text-sm font-medium text-gray-700 mb-1">
                  Type véhicule
                </label>
                <select
                  id="vehicle_type"
                  ...
                  required
                >
                  <option value="" disabled selected>Sélectionner un type véhicule...</option>
              ...
              <div>
                ...
                <select
                  ...
                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                >
                   <option value="" disabled selected>Sélectionner un type carburant...</option>
