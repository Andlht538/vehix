...
class VehiculetController extends Controller
{
    ...
    public function edit(Vehicule $vehicule)
    {
        $user = Auth::user();
         ...
         // Vérification directe du rôle - adaptez selon votre structure
        $isAdmin = $user->role === 'admin' || $user->role === 'ADMIN' || $user->role === 1 || $user->is_admin === true;

        // Les admins peuvent modifier les véhicules validés
        if ($isAdmin && $vehicule->status === VehiculeStatus::VALIDATED) {
