...
Route::middleware([
    ...
    Route::middleware(['role:administrateur'])->prefix('administrateur')->name('administrateur.')->group(function () {
        ...
        Route::delete('/users/{user}', [AdministrateurController::class, 'deleteUser'])->middleware(['auth', 'role:administrateur'])->name('users.delete');
    ...
    // Routes Validateur
    Route::middleware(['role:validator,administrateur'])->prefix('validator')->name('validator.')->group(function () {
