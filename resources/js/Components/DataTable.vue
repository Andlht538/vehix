      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            <tr v-for="item in (data.data || data)" :key="item?.id" class="hover:bg-gray-50">
              <td
                v-for="column in columns"
                :key="column.key"
            ...
            <div>
              <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px">
                <template v-for="link in data.links" :key="link.label">
                  ...
                  >
                    <span v-if="typeof link.label === 'string'" v-text="link.label" />
...
defineProps({
  title: String,
  columns: Array,
  data: [Object, Array], // Accepte objet ou tableau
  showActions: {
    type: Boolean,
    default: true
  }
